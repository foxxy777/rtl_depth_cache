...
dc_shell -f tcl/run_queue.tcl      # Queue 读出（20 设计）
...
| cam_C3 | A + tree2 编码 | 2/4/8/16/32-way × 32-bit |
...
| tag*_Nway_sel | N-way tag 比较 → 选择输出 | 2/4/8-way |
...
**203 个设计，7 个 TCL 脚本。2026-05-04 更新：新增 XOR 比较器、2-way tag+sel、C2/C3 32-way CAM、16/32/64-entry queue read，共 21 个新设计。**
